...
public class Main {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 5; i++) {
            ...
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Python());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Eagle());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Deer());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Horse());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Rabbit());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Mouse());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Goat());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Sheep());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Boar());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Buffalo());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Duck());
            island.getLocation(random(WIDTH), random(HEIGHT)).addAnimal(new Caterpillar());
        }
